      ...
      <form method="post" action="<?= BASE_URL ?>/actions/join-submit.php" id="join-apply-form">
        ...
        <div class="consent-list" style="margin-bottom:20px;">
          <label class="consent-row">
            <input type="checkbox" name="consent_email" value="1" <?= !empty($joinOld) && isset($joinOld['consent_email']) ? 'checked' : '' ?>>
          ...
          <label class="consent-row">
            <input type="checkbox" name="consent_photo" value="1" <?= !empty($joinOld) && isset($joinOld['consent_photo']) ? 'checked' : '' ?>>
          ...
          <label class="consent-row consent-row-required">
            <input type="checkbox" name="consent_rules" value="1" required <?= !empty($joinOld) && isset($joinOld['consent_rules']) ? 'checked' : '' ?>>
